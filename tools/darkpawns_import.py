...
def infer_item_type(obj: Obj) -> Tuple[str, Optional[str]]:
    ...
    semantic_wear_markers = [
        ...
        ("head", (" helm", " helmet", " hood", " crown", " circlet", " tiara", " cap", " cowl", " headband", " headdress", " hat", " halo")),
        ("face", (" mask", " visor", " facemask", " faceguard", " veil")),
    ...
    if obj.obj_type in {3, 4, 10, 24, 25}:
        consumable_wear_markers = (
            ...
            (
                "head",
                ("helm", "helmet", "hood", "crown", "circlet", "tiara", "headband", "halo"),
            ),
            ("face", ("mask", "facemask", "faceguard", "visor", "veil")),
        )
    ...
    if has_any_boundary_phrase(text, ("bulletin board",)):
        return "readable", None
    if has_any_boundary_phrase(long_text, ("bulletin board",)):
        return "readable", None
    if obj.obj_type == 2:
    ...
    if obj.obj_type == 13:
        ...
        if has_any_boundary_phrase(
            text,
            ("throne", "idol", "mirror", "statue", "rose", "looking glass", "look glass"),
        ):
            return "object", None
    ...
    if obj.obj_type == 15:
        ...
        container_wear_markers = (
            ("head", ("helmet", "helm")),
            ("waist", ("beltpouch", "belt pouch", "waist pouch", "waist-pouch", "codpiece", " pouch")),
